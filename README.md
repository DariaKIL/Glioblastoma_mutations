...
4. Make sure your annotated VCF file (if it contains multiple samples) is named according to its type: samplename1_samplename2.anno.vcf. Run the Snakemake workflow to generate tables for each sample:
    ```sh
    snakemake
    ```
